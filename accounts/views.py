...
def profile_view(request):
    ...
    if request.method == "POST":
        ...
        if form_type == "identity":
            return handle_identity_form(request, profile)

        elif form_type == "address":
            return handle_address_form(request, profile)

        elif form_type == "password":
            return handle_password_form(request)

    context = get_profile_context(profile)
